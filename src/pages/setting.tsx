...
const Settings = () => {
  return (
    <div className='flex flex-col min-h-screen'>
     <Navbar/>
     <h1 className="text-3xl  font-bold underline">Setting your Email</h1>
     <section className="flex flex-col max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 md:flex-row md:h-48 mt-6">
